        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <section>
                        <div class="modal fade" id="addItem" tabindex="-1" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="text" autofocus placeholder="Use barcode" 
                                                    id="barcode" autocomplete="off">
    ...
    <script>
        $(document).ready(function()
        {
            ...
            $("#barcode").change(function(e) {
                $.ajax({
                    url: getURL('api/product/searchProductByBarcode'),
                    type : 'get',
                    data: {
                        barcode:$(this).val()
                    },
