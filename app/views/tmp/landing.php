...
<head>
    ...
    <style>
        ...
        body{
          background: url("<?php echo _path_upload_get('images/background.jpg')?>");
          color: #fff !important;
        }
...
<!-- Menu section -->
<section id="menu" class="parallax-section" style="display: none;">
  <div class="container">
    <div class="row">
...
<!-- Gallery section -->
<section id="gallery" class="parallax-section" style="display: none;">
  <div class="container">
    <div class="row">
